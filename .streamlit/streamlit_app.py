...
if uploaded_file:
    try:       
        ...
        def display_visuals(selected_subject):
            ...
            # Display horizontal bar chart for top 10 used words        
            #st.title("Top 10 Occurring Words")
            #st.write("In sentiment analysis, identifying the top 10 occurring words is crucial. These words often reflect the prevailing sentiments within a text dataset, providing insights into common themes or emotional expressions.")
                     
            # Tokenize the preprocessed reviews
            #all_tokens = [word_tokenize(review) for review in df_filtered]
